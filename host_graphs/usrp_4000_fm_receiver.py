...
class usrp_4000_fm_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "usrp_4000_fm_receiver")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("usrp_4000_fm_receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_4000_fm_receiver")
        ...
        # Blocks
        ##################################################
        self._low_pass_transition_range = Range(500, 5000, 100, 1000, 200)
        self._low_pass_transition_win = RangeWidget(self._low_pass_transition_range, self.set_low_pass_transition, 'low_pass_transition', "counter_slider", float)
        self.top_layout.addWidget(self._low_pass_transition_win)
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_float, 1, 'tcp://*:9999', 100, False, -1)
        ...
        self.connect((self.blocks_max_xx_0, 0), (self.blocks_threshold_ff_0, 0))
        self.connect((self.blocks_moving_average_xx_0, 0), (self.blocks_max_xx_0, 0))
        self.connect((self.blocks_moving_average_xx_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_threshold_ff_0, 0), (self.zeromq_pub_sink_0_0, 0))
    ...
    def get_low_pass_transition(self):
        return self.low_pass_transition

    def set_low_pass_transition(self, low_pass_transition):
        self.low_pass_transition = low_pass_transition
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.low_pass_cutoff, self.low_pass_transition, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=usrp_4000_fm_receiver, options=None):
